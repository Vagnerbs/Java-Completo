...
public class Aula_037_Exercicio_006 {
	...
	public static void main(String[] args) {
		...
		if (valor >= 0 && valor <= 25) {
			System.out.println("Inetervalo (0,25)");
		} else if (valor > 25 && valor <= 50) {
			System.out.println("Inetervalo (25,50)");
		} else if (valor > 50 && valor <= 75) {
			System.out.println("Inetervalo (50,75)");
		}  else if (valor > 75 && valor <= 100) {
			System.out.println("Inetervalo (75,100)");
		} else {
